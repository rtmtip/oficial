...
rDownloadURL = {"main": "https://www.dropbox.com/s/5d8f0vukri09edv/main_xtreamcodes_reborn.tar.gz?dl=1", "sub": "https://www.dropbox.com/s/n1kh8uctxswljm9/sub_xtreamcodes_reborn.tar.gz?dl=1"}
...
def prepare(rType="MAIN"):
    ...
    os.system("wget -q -O /tmp/libpng12.deb https://www.dropbox.com/s/krcxw003k6foi4k/libpng12-0_1.2.54-1ubuntu1_amd64.deb?dl=1")
...
def installadminpanel():
    rURL = "https://www.dropbox.com/s/86vjqu0pfw9zucc/release_22f.zip?dl=1"
    ...
    rURL2 = "https://www.dropbox.com/s/615puz3eanokmfh/newstuff.zip?dl=1"
...
def configure():
    ...
    os.system("wget -q https://www.dropbox.com/s/2dj9odvqqtbsn2k/nginx?dl=1 -O /home/xtreamcodes/iptv_xtream_codes/nginx/sbin/nginx")
    os.system("wget -q https://www.dropbox.com/s/k1tly8ssgzta88b/nginx_rtmp?dl=1 -O /home/xtreamcodes/iptv_xtream_codes/nginx_rtmp/sbin/nginx_rtmp")
    os.system("wget -q https://www.dropbox.com/s/rwtg0ogm4sdd4ni/pid_monitor.php?dl=0 -O /home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php")
    ...
    os.system("wget -q https://www.dropbox.com/s/2r9f90p14batadp/GeoLite2.mmdb?dl=1 -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb")
    os.system('chattr -f +i /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb > /dev/null')
        ...
        if len(rHost) > 0 and len(rPassword) > 0 and rServerID > -1:
            ...
            if raw_input("  ").upper() == "Y":
                ...
                if rType.upper() == "MAIN":
                    ...
                    printc("http://%s:25500/%s" % (getIP(), rAccesscode))
